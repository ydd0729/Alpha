...
var ASM_CONSTS = {
  6177352: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 6177407: ($0) => { performance.now = function() { return $0; }; },  
 6177455: ($0) => { performance.now = function() { return $0; }; },  
 6177503: () => { performance.now = Module['emscripten_get_now_backup']; }
};
